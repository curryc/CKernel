...
namespace GDT
{
    ...
    /// 数据段，读写，？可访问
    static constexpr const uint32_t TYPE_DATA_READ_WRITE_EXPAND_DOWN_ACCESSED = 0x07;
    ...
    /// 代码段，仅执行，？，可访问
    static constexpr const uint32_t TYPE_CODE_EXECUTE_ONLY_CONFORMING_ACCESSED = 0x0D;
    /// 代码段，可执行，可读，？
    static constexpr const uint32_t TYPE_CODE_EXECUTE_READ_CONFORMING = 0x0E;
    /// 代码段，可执行，可读，？，可访问
    static constexpr const uint32_t TYPE_CODE_EXECUTE_READ_CONFORMING_ACCESSED = 0x0F;
