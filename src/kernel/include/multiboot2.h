 ...
 */
 ...
 #ifndef CKERNEL_MULTIBOOT2_H
 #define CKERNEL_MULTIBOOT2_H
...
private:
    ...
    static constexpr const uint32_t MULTIBOOT_HEADER_TAG_INFORMATION_REQUEST = 1;
    ...
    static constexpr const uint32_t MULTIBOOT_HEADER_TAG_ENTRY_ADDRESS_EFI32 = 8;
    static constexpr const uint32_t MULTIBOOT_HEADER_TAG_ENTRY_ADDRESS_EFI64 = 9;
    ...
    static constexpr const uint32_t MULTIBOOT_CONSOLE_FLAGS_CONSOLE_REQUIRED = 1;
    static constexpr const uint32_t MULTIBOOT_CONSOLE_FLAGS_EGA_TEXT_SUPPORTED = 2;
